...
状态：完成。最佳验证mIoU=0.7863238948（epoch 54）；官方测试集1mIoU=0.673862。
...
- 最佳epoch：54。
- scene-guard验证mIoU：0.7863238948235227；完整诊断重算差值为0。
- 像素准确率：0.8839692151904438。
- ID1-8 IoU：0.6876040728、0.8372765673、0.7583134412、0.8870423993、
  0.6214851461、0.8740657970、0.8131398463、0.8116638886。
- 相比同口径A03验证提升1.7672个百分点，八个有效类别全部提升。
- 用户报告官方测试集1mIoU=0.673862；相比A00的0.669362提升0.4500个百分点，成为
  当前合规路线最高官方成绩。
